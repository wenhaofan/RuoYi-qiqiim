...
CREATE TABLE `sys_job`  (
  ...
  `job_group` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '任务组名',
  `method_name` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '' COMMENT '任务方法',
  `method_params` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '方法参数',
...
CREATE TABLE `sys_job_log`  (
  ...
  `method_name` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '任务方法',
  `method_params` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '方法参数',
...
CREATE TABLE `sys_role`  (
  ...
  `data_scope` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT '1' COMMENT '数据范围（1：全部数据权限 2：自定数据权限）',
...
-- ----------------------------
INSERT INTO `user_info` VALUES (1, 3, 1, '张三', NULL, NULL, NULL, NULL, '我的签名', NULL, NULL, NULL, NULL, NULL, NULL, '/layui/images/0.jpg', '2017-11-27 15:08:41', 3, '2017-11-27 15:08:41', 3);
...
INSERT INTO `user_message` VALUES (113, '8', '3', '', 1, 0, '你好，在干什么呢face[疑问] ', NULL, '2017-11-29 11:35:31', '2019-05-27 11:46:22');
...
INSERT INTO `user_message` VALUES (115, '8', '3', '', 1, 0, '你发的这个图好挫face[偷笑] ', NULL, '2017-11-29 11:36:30', '2019-05-27 11:46:22');
