package com.ruoyi.project.im.webserver.dwrmanage.session;
	...
	public DwrScriptSessionManagerImpl(){  
        ...
        addScriptSessionListener(  new ScriptSessionListener() {  
              ...
              public void sessionCreated(ScriptSessionEvent ev) {  
                    ...
                    httpSession.setAttribute(IMConstants.DWRConfig.SS_KEY, scriptSession.getId());  
                    scriptSession.setAttribute(IMConstants.SessionConfig.SESSION_KEY, userId);  
                    scriptSession.setAttribute("SESSIONID", httpSession.getId());  
                    scriptSession.setAttribute(IMConstants.DWRConfig.BROWSER, browser.getName()); 
                    scriptSession.setAttribute(IMConstants.DWRConfig.BROWSER_VERSION, version.getVersion());
                 ...
                 public void sessionDestroyed(ScriptSessionEvent ev) {  
                    ...
                    if (ss.getAttribute(IMConstants.SessionConfig.SESSION_KEY) != null){  
                        logger.info(" script session destroyed: " + ss.getAttribute(IMConstants.SessionConfig.SESSION_KEY));  
                    }  
                 }  
          } );  
