 ...
 ***************************************************************************************
 */
package com.ruoyi.project.im.server.connertor.impl;
...
import com.ruoyi.project.im.server.exception.PushException;
...
public class ImConnertorImpl implements ImConnertor{
	...
	public void pushMessage(String sessionId,MessageWrapper wrapper) throws RuntimeException{
		//判断是不是无效用户回复    
		if(!sessionId.equals(IMConstants.ImserverConfig.REBOT_SESSIONID)){//判断非机器人回复时验证
