 ...
 ***************************************************************************************
 */
package com.ruoyi.project.im.server.model;
...
public class Session   implements Serializable{
	...
	public void setAccount(String account) {
		...
		setAttribute(IMConstants.SessionConfig.SESSION_KEY, account);
	}
	...
	public  boolean write(Object msg) {
		...
		if(session!=null&&isConnected())
		{
			...
			try{
				...
				script.appendCall(IMConstants.DWRConfig.DWR_SCRIPT_FUNCTIONNAME, JSONArray.toJSON(map));  
